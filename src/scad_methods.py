#!/usr/bin/env python3
"""
SCAD Methods Module for Hierarchical Network Regression

This module implements the 4-step SCAD algorithm:
1. SCAD original (without merge)
2. SCAD merged (with path merging)  
3. SCAD random augmentation
4. SCAD confidence-based iterative augmentation
...
def scad_method_step1_original(A_original: np.ndarray, b: np.ndarray) -> Dict[str, Any]:
    """
...
def scad_method_step2_merged(tree: Tree, b: np.ndarray) -> Dict[str, Any]:
    """
...
def scad_method_step3_random(A: np.ndarray, b: np.ndarray, tree: Tree, 
...
def scad_method_step4_iterative(A: np.ndarray, b: np.ndarray, tree: Tree, 
