...
Handles:
1. Synthetic Table S.7 results (results/synthetic/)
2. SCAD 4-Step results (results/main_scad/)
3. Other Methods results (results/other_methods/)

Usage:
    python postprocess/merge_table_results.py
    python postprocess/merge_table_results.py --synthetic  # Only merge synthetic results
    python postprocess/merge_table_results.py --scad       # Only merge SCAD results
    python postprocess/merge_table_results.py --other      # Only merge Other Methods results
"""
...
SYNTHETIC_RESULTS_DIR = BASE_DIR / "results" / "synthetic"
SCAD_RESULTS_DIR = BASE_DIR / "results" / "main_scad"
OTHER_RESULTS_DIR = BASE_DIR / "results" / "other_methods"
