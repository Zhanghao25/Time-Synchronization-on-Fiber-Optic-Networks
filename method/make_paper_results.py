...
- Tables:  Table 1 and Tables S.1-S.7 -> results/tables/
- Figures: Figure 5, Figure S.5, Figure S.6 (+ plot data) -> results/figures/

Usage:
    python method/make_paper_results.py             # tables + figures
    python method/make_paper_results.py --tables    # tables only
    python method/make_paper_results.py --figures   # figures only
"""
...
TABLE_SPECS = [
    TableSpec("table1", "Table 1", "grouped_city", ALPHA_COL, PLAIN_METHOD_MAP_MAIN, PDF_METHOD_MAP_MAIN),
    TableSpec("table_s1", "Table S.1", "simple"),
    TableSpec("table_s2", "Table S.2", "grouped_city", ALPHA_COL, PLAIN_METHOD_MAP_OTHER, PDF_METHOD_MAP_OTHER),
    TableSpec("table_s3", "Table S.3", "grouped_city", ALPHA_COL, PLAIN_METHOD_MAP_OTHER, PDF_METHOD_MAP_OTHER),
    TableSpec("table_s4", "Table S.4", "grouped_city", ALPHA_COL, PLAIN_METHOD_MAP_OTHER, PDF_METHOD_MAP_OTHER),
    TableSpec("table_s5", "Table S.5", "grouped_city", ALPHA_COL, PLAIN_METHOD_MAP_OTHER, PDF_METHOD_MAP_OTHER),
    TableSpec("table_s6", "Table S.6", "grouped_city", ALPHA_COL, PLAIN_METHOD_MAP_MAIN, PDF_METHOD_MAP_MAIN),
    TableSpec("table_s7", "Table S.7", "grouped_metric", ZETA_COL, PLAIN_METHOD_MAP_MAIN, PDF_METHOD_MAP_MAIN),
]
...
def render_from_dataframe(
    ...
    xlsx_path = output_dir / f"{spec.name}.xlsx"
...
def export_tables_from_frames(frames: dict[str, pd.DataFrame], output_dir: Path | str = "results/tables") -> Path:
    ...
    combined_xlsx = output_dir / "all_tables.xlsx"
    combined_pdf = output_dir / "all_tables.pdf"
...
def build_all_tables(results_root: Path, allow_missing: bool = False, export_tex: bool = False) -> None:
    ...
    if export_tex:
        tex_lines = ["% Auto-generated by method/make_paper_results.py", ""]
