...
Usage:
    python experiments/other_methods_experiment.py                                 # Run all methods with default data (10 experiments)
    python experiments/other_methods_experiment.py --data data/city1.xlsx          # Use custom data file
    python experiments/other_methods_experiment.py --method Lasso                  # Run single method
    python experiments/other_methods_experiment.py --merge                         # Use merged matrix
    python experiments/other_methods_experiment.py --experiments 10                # Run 10 experiments
    python experiments/other_methods_experiment.py --save results/output.xlsx      # Save results to file
"""
...
Examples:
    python experiments/other_methods_experiment.py                                # Run all methods with default data (10 experiments)
    python experiments/other_methods_experiment.py --data your_data.xlsx          # Use custom data file
    python experiments/other_methods_experiment.py --method Lasso                 # Run single method
    python experiments/other_methods_experiment.py --merge                        # Use merged matrix
    python experiments/other_methods_experiment.py --ratio 0.15 --seed 123       # Custom parameters
    python experiments/other_methods_experiment.py --experiments 20               # Run 20 experiments
    python experiments/other_methods_experiment.py --save results.xlsx           # Save results to file
        """
    )
