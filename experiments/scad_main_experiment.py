...
Usage:
    python experiments/scad_main_experiment.py --data data/city1.xlsx --experiments 10 --save results/scad_results.xlsx
"""
...
def run_four_step_scad(A_original: np.ndarray, A_merged: np.ndarray, 
    ...
    results['step1'] = scad_method_step1_original(A_original, b_original)
    ...
    results['step2'] = scad_method_step2_merged(tree_merged, b_merged)
    ...
    results['step3'] = scad_method_step3_random(A_merged, b_merged, tree_merged, x_true_merged)
    ...
    results['step4'] = scad_method_step4_iterative(A_merged, b_merged, tree_merged, x_true_merged, add_high=True)
